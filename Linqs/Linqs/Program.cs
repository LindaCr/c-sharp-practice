    ...
    class Program
    {
        static void Main(string[] args)
        {
            static void Linq()
            {
                ...
                //calculate the smallest sum using four items.
                //calculate the largest sum using four items.
                var smallSum = ints2.Sum() - ints2.Max();
                var largeSum = ints2.Sum() - ints2.Min();
                Console.WriteLine($"Smallest sum is {smallSum} and largest sum is {largeSum}");
             ...
             5035,1380,1164,4120,4146,7290,3518,7581,6727,5657
                ...
                var nbr = ints.Where(i => i % 5 == 0 || i % 7 == 0).Average();
                Console.WriteLine($"Average of all numbers divisible by 5 or 7 is {nbr}");
            }
        }
    }
}
